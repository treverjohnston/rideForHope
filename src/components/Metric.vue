            ...
            <div class="col-xs-12 col-md-4">
                ...
                <div class="row wrap justify-center">
                    <h6 class="top light-paragraph text-center col-xs-11 col-md-11 r-links">
                        ...
                        vineyards and 4 rest stops. The course meets up with the last half of the Century route (so you will
                        have additional riders to share your challenge with along the way). You will continue northwest toward
                        Marsing and then turn back toward Kuna and pedal, pedal, pedal, to Lake Shore Drive skirting Lake
                        Lowell on your way back to the finish line where festivities and food await, (if you are fast enough!).
                        Just remember, Humpty Dumpty had wall issues too but he overcame; so can you!
                    </h6>
                            ...
                            <div>
                                ...
                                <q-card-actions class="desktop-only" align="center">
                                    <q-collapsible class="white-text" label="View More Map Options">
                                        <q-btn class="r-btn" @click="launch('//www.mapmyride.com/routes/view/981667107')" no-caps>Map My Ride</q-btn>
                                        <q-btn class="r-btn" @click="launch('//www.strava.com/routes/4093800')" no-caps>Strava</q-btn>
                                        <q-btn class="r-btn" @click="launch('//connect.garmin.com/modern/course/16760339')" no-caps>Garmin</q-btn>
                                        <q-btn class="r-btn" @click="launch('//ridewithgps.com/routes/26451173')" no-caps>Ride With GPS</q-btn>
                                    </q-collapsible>
                                </q-card-actions>
